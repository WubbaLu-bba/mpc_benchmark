...
int32_t test_mult_circuit(e_role role, char* address, uint16_t port, seclvl seclvl,
    ...
    sprintf(fname, "/root/ABY/src/examples/mult/data/mult.%d.dat", role);
     ...
     */
    s_out = BuildSharedMultCircuit(i0, i1, circ);
...
// constructs a mult circuit
share * BuildSharedMultCircuit(share *s_0, share *s_1,

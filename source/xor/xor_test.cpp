...
int32_t read_test_options(int32_t* argcp, char*** argvp, e_role* role,
	...
	parsing_ctx options[] =
			{ { (void*) &int_role, T_NUM, "r", "Role: 0/1", true, false },
			  { (void*) nvals, T_NUM, "n",	"Number of elements for bitwise xor", false, false },
...
int main(int argc, char** argv) {
	...
	e_role role;
	uint32_t bitlen = 16, nvals = 3, secparam = 128, nthreads = 1;
	uint16_t port = 7766;
	...
	test_xor_circuit(role, (char*) address.c_str(), port, seclvl, 1, bitlen, nthreads, mt_alg, S_ARITH, nvals);

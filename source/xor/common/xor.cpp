...
int32_t test_xor_circuit(e_role role, char* address, uint16_t port, seclvl seclvl,
    ...
    sprintf(fname, "/root/ABY/src/examples/xor/data/xor.%d.dat", role);
...
share * BuildSharedXorCircuit(share *s_0, share *s_1,
                                BooleanCircuit *bc) {
    share *out = bc->PutXORGate(s_0, s_1);

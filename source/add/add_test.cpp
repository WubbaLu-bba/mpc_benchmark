...
int32_t read_test_options(int32_t* argcp, char*** argvp, e_role* role,
	...
	parsing_ctx options[] =
			{ { (void*) &int_role, T_NUM, "r", "Role: 0/1", true, false },
			  { (void*) nvals, T_NUM, "n",	"Number of elements for add sum", false, false },
...
int main(int argc, char** argv) {
	...
	test_add_circuit(role, (char*) address.c_str(), port, seclvl, 1, bitlen, nthreads, mt_alg, S_ARITH, nvals);
